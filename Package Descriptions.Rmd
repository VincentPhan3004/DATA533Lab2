...
* **HRfunction**: This module contains two functions

  - **promoteheck(employeelist)**: The turn ID of staffs in the list who has no promotion in two year since the last promotion until the end of the current year.
  - **serviceCheck(employeelist)**: The turn ID of staffs in the list who have  smallest entry year.
